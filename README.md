# FakeBlueScreen
 	<p>FakeBlueScreen is a fake BSOD Window for windows systems coded in 
...
this application is running.</p>
<br /><br />
	<p>There are two ways to terminate the program. The first is the three 
...
use with caution.</p>
<br />
	<p>You may need Java Runtime Environment to run these files.</p>
